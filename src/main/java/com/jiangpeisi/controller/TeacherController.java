...
public class TeacherController {
    ...
    public @ResponseBody
    String login(@RequestBody Teacher teacher) {
    ...
    public @ResponseBody
    String insert(@RequestBody Teacher teacher) {
    ...
    public @ResponseBody
    String updatePassword(@RequestBody Teacher teacher) {
    ...
    public @ResponseBody
    String update(@RequestBody Teacher teacher) {
    ...
    public @ResponseBody
    String delete(@RequestBody Teacher teacher) {
    ...
    public @ResponseBody
    String offerCourse(@RequestBody CourseOffering course_offering) {
...
/*
    ...
    public @ResponseBody String quote_Resource(@RequestBody Course_Offering_Resource course_offering_resource){
        ...
        return teacherService.quoteResource(course_offering_resource);
}*/

    @RequestMapping("/findQuoteResource")
    public @ResponseBody
    CourseOffering findQuoteResource(@RequestBody CourseOffering course_offering) {
